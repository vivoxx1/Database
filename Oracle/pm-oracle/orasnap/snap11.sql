REM ===========================================================================================
REM
REM  Script:  snap10.sql
REM  Author:  Stewart McGlaughlin (orasnap@hotmail.com)
REM  Website: http://www.oracle.books.com/orasnap
REM
REM  Desc:    This script generates HTML formatted reports.
REM        
REM  Notes:   This script is designed for an Oracle v10.x database.
REM           Use snap7.sql for v7.3.x databases.
REM           Use snap8.sql for v8.x databases.
REM           Use snap9.sql for v9.x databases.
REM
REM  Usage:   sqlplus sys/<password> @snap10 (from client)
...
-- MINISNAP
start sql/minisnap10     -- Quick DB Snapshot
...
-- BACKUPS
start sql/RMANBJ        -- RMAN Backup Jobs Information
start sql/RMANConf      -- RMAN Configuration
start sql/RMANBS        -- RMAN Backup Sets
start sql/RMANBP        -- RMAN Backup Pieces
start sql/ArcDs         -- Archive Destinations
start sql/ArcIp         -- Archive Instance Parameters
start sql/ArcHist       -- Archive  History
