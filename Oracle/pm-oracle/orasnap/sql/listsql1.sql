...
set termout on
prompt Retrieving Disk Intensive SQL...
set termout off

spool output/listsql1.htm
prompt <HTML>
prompt <HEAD>
...
prompt <TR>
select '<TD><B><FONT FACE="Arial" SIZE="2"><A HREF="listsql1.htm" TARGET="_blank">'||SYSDATE||'</A></FONT></B></TD>' from dual;
...
prompt  <FONT SIZE="4"><B>Shared Pool SQL with Most Disk Reads (&gt; 10000)</B></FONT>
prompt  </TD>
prompt </TR>
prompt <TR>
...
select '<TR>
	...
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||to_char(a.disk_reads,'999G999G999G999G999')||'</FONT></TD>
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||to_char(a.executions,'999G999G999G999G999')||'</FONT></TD>
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||to_char(a.disk_reads / decode(a.executions, 0, 1, a.executions),'999G999G999G999G999')||'</FONT></TD>
...
prompt </TABLE><BR>
prompt <FORM ACTION="../source/listsql1.htm" METHOD=GET>
