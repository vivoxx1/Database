...
set termout on
prompt Retrieving Partitioned Tables...
set termout off

spool output/part_tabs.htm
prompt <HTML>
prompt <HEAD>
...
prompt <TR>
select '<TD><B><FONT FACE="Arial" SIZE="2"><A HREF="part_tabs.htm" TARGET="_blank">'||SYSDATE||'</A></FONT></B></TD>' from dual;
select '<TD ALIGN="RIGHT"><B><FONT FACE="Arial" SIZE="2">'||name||'</FONT></B></TD>' from sys.v_$database;
prompt </TR>
prompt </TABLE><BR>
prompt <TABLE BORDER=1 CELLPADDING=5>
prompt <TR>
prompt  <TD ALIGN="CENTER" BGCOLOR="#FFFFFF" COLSPAN=19>
prompt  <FONT SIZE="4"><B>Partitioned Tables</B></FONT>
prompt  </TD>
prompt </TR>
prompt <TR>
...
select '<TR>
	...
	<TD><FONT FACE="Arial" SIZE="2">'||def_tablespace_name||'</FONT></TD>
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||decode(def_pct_free,NULL,'&nbsp;',def_pct_free)||'</FONT></TD>
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||decode(def_pct_used,NULL,'&nbsp;',def_pct_used)||'</FONT></TD>
	...
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||decode(def_freelists,NULL,'&nbsp;',def_freelists)||'</FONT></TD>
	<TD ALIGN="CENTER"><FONT FACE="Arial" SIZE="2">'||decode(def_freelist_groups,NULL,'&nbsp;',def_freelist_groups)||'</FONT></TD>
...
prompt </TABLE><BR>
prompt <FORM ACTION="../source/part_tabs.htm" METHOD=GET>
