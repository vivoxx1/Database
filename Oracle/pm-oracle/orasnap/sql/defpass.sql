REM ===========================================================================================
REM
REM  Script:  defpass.sql
REM  Author:  Stewart McGlaughlin (orasnap@hotmail.com)
REM  Website: http://www.oracle-books.com/orasnap
REM  
REM  Sources: Pete Finnigan default password checker (03/2006)
REM
REM ===========================================================================================

set termout on
prompt Retrieving Accounts With Default Password...
set termout off

spool output/defpass.htm
prompt <HTML>
prompt <HEAD>
...
prompt <TR>
select '<TD><B><FONT FACE="Arial" SIZE="2"><A HREF="defpass.htm" TARGET="_blank">'||SYSDATE||'</A></FONT></B></TD>' from dual;
...
prompt  <FONT SIZE="4"><B>Accounts With Default Password</B></FONT>
prompt  </TD>
prompt </TR>
prompt <TR>
prompt 	<TD ALIGN="CENTER" BGCOLOR="#CCCC99"><FONT FACE="Arial" SIZE="2"><B>Username (1)</B></FONT></TD>
prompt 	<TD ALIGN="CENTER" BGCOLOR="#CCCC99"><FONT FACE="Arial" SIZE="2"><B>Password</B></FONT></TD>
...
select 	'<TR>
	...
	<TD ALIGN=CENTER><FONT FACE="Arial" SIZE="2">'||password||'</FONT></TD>
	<TD ALIGN=CENTER><FONT FACE="Arial" SIZE="2">'||created||'</FONT></TD>
	</TR>'
FROM dba_users
...
ORDER BY username;
prompt </TABLE><BR>
prompt <FORM ACTION="../source/defpass.htm" METHOD=GET>
