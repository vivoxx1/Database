...
set termout on
prompt Retrieving All non-default RMAN configuration settings...
set termout off

spool output/RMANConf.htm
prompt <HTML>
prompt <HEAD>
...
prompt <TR>
select '<TD><B><FONT FACE="Arial" SIZE="2"><A HREF="RMANConf.htm" TARGET="_blank">'||SYSDATE||'</A></FONT></B></TD>' from dual;
...
prompt  <FONT SIZE="4"><B>All non-default RMAN configuration settings</B></FONT>
prompt  </TD>
prompt </TR>
prompt <TR>
...
ORDER BY
    name;
prompt </TABLE><BR>
prompt <FORM ACTION="../source/RMANConf.htm" METHOD=GET>
